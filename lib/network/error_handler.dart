...
class ResponseMessage {
  ...
  static String noContent = StringsManager.success; // success with no data (no content)
  static String badResponse = StringsManager.badResponseError; // failure api rejected request
  static String unauthorized = StringsManager.unauthorizedError; // failure, user is not authorized
  static String forbidden = StringsManager.forbiddenError; // failure api rejected request
  static String internalServerError = StringsManager.internalServerError; // failure, crash in server side
